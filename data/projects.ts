...
export const PROJECTS: Project[] = [
  {
    ...
    storyPratz: "I built a high-performance marketplace that simplifies complex agricultural data into actionable insights for farmers, combining commerce with community.",
  ...
  },
  {
    ...
    storyPratz: "I built a gesture-driven discovery engine that reduced search time by 40% and significantly increased user engagement sessions.",
  ...
  },
  {
    ...
    storyPratz: "I delivered a high-availability mobile platform that ensures critical project data is always at the team's fingertips, regardless of connectivity.",
  ...
  },
  {
    ...
    storyPratz: "We built a zero-failure recharge platform that handles millions of transactions with perfect data integrity and sub-second response times.",
  ...
  },
  {
    ...
    storyPratz: "We built a comprehensive E2E strategy and optimized the CI pipeline, cutting build times by 50% while establishing reusable component patterns for scale.",
  ...
  },
  {
    ...
    storyPratz: "We engineered a multi-sided marketplace that triggers competitive offers from local realtors, solving friction for both sides simultaneously.",
  ...
  },
  {
    ...
    storyPratz: "We optimized the matrix table using React concurrency and memoization, achieving 10x performance gains and standardizing the UI patterns.",
  ...
  },
  {
    ...
    storyPratz: "We built a visual project generator that eliminates 150+ lines of boilerplate per project, earning 120+ organic GitHub stars.",
  ...
  },
  {
    ...
    storyPratz: "We rebuilt the entire flagship ecosystem, driving 25% more traffic and enabling 80+ monthly healthcare appointments via a new digital booking system.",
  ...
  },
  {
    ...
    storyPratz: "We built a smooth, high-engagement hub that students embraced, moving from fragmented emails to a single, vibrant campus pulse.",
  ...
  },
  {
    ...
    storyPratz: "We delivered a zero-latency healthcare portal that prioritizes security and clarity, ensuring data is always accessible when it matters most.",
